import { YToken } from './../types/schema'
...
import { getHtPriceInUSD, findEthPerToken, getTrackedVolumeUSD, getTrackedLiquidityUSD } from './pricing'
import {
...
export function handleSync(event: Sync): void {
  ...
  let conver_reserve0 = convertTokenToDecimal(event.params.reserve0, token0.decimals)
  let conver_reserve1 = convertTokenToDecimal(event.params.reserve1, token1.decimals)
  
  pair.reserve0 = pair.reserveWithDummy0 = conver_reserve0
  pair.reserve1 = pair.reserveWithDummy1 = conver_reserve1
  ...
  bundle.ethPrice = getHtPriceInUSD()
  bundle.save()
